...
tf.flags.DEFINE_string("logs_dir", "logs/shape_256_to_64", "path to logs directory")
...
def inference(image, keep_prob):
    ...
    with tf.variable_scope("inference"):
        ...
        W_s2_4 = utils.weight_variable([1, 1, 256, 64], name="W_s2_4")
        b_s2_4 = utils.bias_variable([64], name="b_s2_4")
        ...
        W_label = utils.weight_variable([1, 1, 320, NUM_OF_CLASSESS], name="W_label")
